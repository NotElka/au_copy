...
(function(e) {
 ...
 e.modal = function(i, n) {
  ...
  if (this.options.mode == 'video') {
   ...
   var l = e('<iframe width="854" height="480" frameborder="0" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>');
   var r;
   var h;
...
(function(t, e, s, r) {
 t.fn.quicksearch = function(s, r) {
  var i, n, o, u, l = '', h = this, a = t.extend({
   delay: 500,
   selector: null,
   stripeRows: null,
   loader: null,
  ...
  this.go = function() {
   var t = 0, e = 0, s = true, r = a.prepareQuery(l), i = l.replace(' ', '').length === 0;
   for (var t = 0, u = o.length; t < u; t++) {
    if (i || a.testQuery(r, n[t], o[t])) {
     a.show.apply(o[t]);
     s = false;
     e++;
    } else {
  ...
  this.stripe = function() {
   if (typeof a.stripeRows === "object" && a.stripeRows !== null) {
    ...
    u.not(':hidden').each(function(r) {
     t(this).removeClass(e).addClass(a.stripeRows[r % s]);
    });
   }
   return this;
  };
  ...
  this.cache = function() {
   ...
   n = e.map(function() {
    if (this.nodeName === 'OPTION' && this.title !== '') {
     return h.strip_html(this.title);
    } else {
