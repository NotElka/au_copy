...
BB.externalSiteSearch = function(t, e) {
 ...
 switch (t) {
 case 'google':
  i = 'https://www.google.com/search?q=site%3Arutracker.org%20' + n;
  break;

 case 'duckduckgo':
  i = 'https://duckduckgo.com/?q=site:rutracker.org%20' + n;
  break;
...
BB.banned_img_hosts_reg = /comss\.pics|keep4u|centrkino|flashrelease|hidebehind|imagebanana|imageshack|imagevenue|imgur|interfoto|ipicture|photobucket|tinypic|(youpic|upimg|sendpic|radikal|hq\-video)\.ru|(rimg|ifotki)\.info/i;
...
$(function() {
 ...
 $('#quick-search').on('submit', function() {
  ...
  case 'google':
   BB.externalSiteSearch('google', a);
   return false;
 ...
 FileTree.prototype = {
  ...
  build_file_tree: function(i) {
   ...
   e(this.li_files, function(i) {
    var t = i.firstChild.children, e = t[0], r = t[1], s = t[2];
    var n = parseInt(s.innerHTML);
    r.textContent = ' ' + BB.humnSize(n) + ' ';
    var l = i.parentNode.parentNode;
    l.ftreeDirSize += n;
    this.highlight_filenames(e);
   });
   e(this.li_dirs, function(i) {
    var t = i.firstChild.firstChild;
    this.highlight_filenames(t);
    ...
    if (n > 1) {
     s.sort(function(i, t) {
      ...
      if (e && !r) {
       ...
       var s = i.firstChild.firstChild.innerHTML;
       var n = t.firstChild.firstChild.innerHTML;
  ...
  highlight_filenames: function(i) {
   var t = i.innerHTML + '';
   if (/~uTorrentPartFile|padding_file/i.test(t)) {
    i.className = 'ext-group-1';
   } else if (/\.(wav|url|torrent|scr|pad)$|Thumbs\.db$/i.test(t)) {
    i.className = 'ext-group-1';
   } else if (/\.(exe|com|bat|cmd|msi|vbs|ps1)$/i.test(t)) {
    i.className = 'ext-group-1';
  ...
  get_flat_file_list: function(i) {
   ...
   for (var e = 0, r; r = this.li_files[e++]; ) {
    var s = r.firstChild.children;
    var n = s[2].innerHTML;
    var l = s[0].textContent;
    t.push('<i>' + n + '</i><b>' + l + '</b>');
   }
  ...
  sort_li_files_by_size: function(i) {
   ...
   this.li_files.sort(function(i, e) {
    ...
    var s = parseInt(e.firstChild.children[2].innerHTML);
    return t ? r - s : s - r;
   });
  },
  ...
  do_comparison_with: function(i, t) {
   ...
   this.build_comparison_result(i, s, n, l, o);
  },
  build_comparison_result: function(i, t, e, r, s) {
   var n = Object.keys(e).sort(function(i, t) {
    return t - i;
   });
   var l = $('#cmp-results');
   ...
   n.forEach(function(i) {
    ...
    var s = e[i].join('</li><li>');
    h += t[i].length;
    c += e[i].length;
    a.push([ '<td class="this-f"><ul><li>' + r + '</li></ul></td>', '<td class="other-f"><ul><li>' + s + '</li></ul></td>' ].join(''));
   });
   if (a.length) {
   ...
   var f = Object.keys(r).sort();
   var _ = f.length;
   if (_) {
    o.find('td.cmp-this-diff').append('<ul><li>' + f.join('</li><li>') + '</li></ul>');
   ...
   if (_ || u) {
    o.find('.cmp-diff-count').show().find('b').html(_ + ' / ' + u);
   }
   o.prependTo(l).show();
   l.show();
  },
